...
// Fluid cursor inspired by community experiments; adapted for React usage.
    ...
    const vorticityShader = compileShader(
      ...
      `
        ...
        void main () {
            ...
            vec2 velocityVec = texture2D(uVelocity, vUv).xy;
            velocityVec += force * dt;
            velocityVec = min(max(velocityVec, -1000.0), 1000.0);
            gl_FragColor = vec4(velocityVec, 0.0, 1.0);
        }
      `
    );
    ...
    const pressureShader = compileShader(
      ...
      `
        ...
        void main () {
            ...
            float divergenceVec = texture2D(uDivergence, vUv).x;
            float pressureVal = (L + R + B + T - divergenceVec) * 0.25;
            gl_FragColor = vec4(pressureVal, 0.0, 0.0, 1.0);
        }
      `
    );
